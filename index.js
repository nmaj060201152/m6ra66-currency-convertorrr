...
async function main() {
    ...
    const convertedAmount = (parseFloat(amount.amount) / conversionRates[fromCurrency.fromCurrency]) *
        conversionRates[toCurrency.toCurrency];
    console.log(chalk.greenBright(`${amount.amount} ${fromCurrency.fromCurrency} is approximately ${convertedAmount.toFixed(2)} ${toCurrency.toCurrency}`));
}
main();
